            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-left">
                        <h5>Transaksi Peminjaman Buku</h5>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('simpan-peminjaman') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-5" style="background-color:gold; border-radius:10px;">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tgl_pinjam" value="" class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label for="" style="visibility: hidden;">Kode</label>
                                    <a href="#" class="btn btn-danger btn-sm" id="hapusAll"><i class="fas fa-trash"></i>
                                        Item</a>
                                </div>
                            </div>
