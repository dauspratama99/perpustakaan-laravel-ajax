...
<body>
    ...
    <h5 class="text-center mt-2">Laporan Data Petugas</h5>
    ...
    <div class="container">
        ...
        <table class="table table-bordered mb-4 table-striped">
            <tr>
                ...
                <th style="text-align: center;">Nohp / Wa</th>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{$data->jabatan_petugas}}</td>
                <td style="text-align: center;">{{$data->nohp_petugas}}</td>
                <td style="text-align: center;">{{$data->email_petugas}}</td>
                <td style="text-align: center;">{{$data->alamat_petugas}}</td>
            </tr>
