...
<body>
    ...
    <h5 class="text-center mt-2">Laporan Data Anggota</h5>
    ...
    <div class="container">
        ...
        <table class="table table-bordered mb-4 table-striped">
            ...
            <tr>
                ...
                <td style="text-align: center;">{{$data->jk_anggota}}</td>
                <td style="text-align: center;">{{$data->nohp_anggota}}</td>
                <td>{{$data->email_anggota}}</td>
                <td style="text-align: center;">{{$data->alamat_anggota}}</td>
            </tr>
